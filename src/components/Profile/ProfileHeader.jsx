...
const ProfileHeader = () => {
  ...
  const vissitingOwnProfileAndAuth= authUser && authUser.username === userProfile.username;
  const vissitingAnotherProfileAndAuth= authUser && authUser.username !== userProfile.username;
  return (
   <Flex gap={{base:10,sm:10}} py={10} direction={{base:"column",sm:'row'}} pl={20}>
    <AvatarGroup size={{base:"xl",md:"2xl"}} justifySelf={'center'} alignSelf={'self-start'} mx={'auto'}>
      <Avatar name='artist_1' src={userProfile.profilePicURL} alt="profile img">
    ...
    <VStack alignItems={'start'} gap={2} mx={'auto'} flex={1}>
      ...
      <Flex gap={4} direction={{base:"column",sm:'row'}} justifyContent={{base:'center',sm:'flex-start'}} alignItems={'center'} w={'full'}>
        ...
        { vissitingOwnProfileAndAuth && (<Flex gap={4} alignItems={'center'} justifyContent={'center'}>

            <Button onClick={onOpen}
             bg={'white'} color={'black'} _hover={{bg:"whiteAlpha.800"}} size={{base:'xs',md:'sm'}}> 
            Edit Profile
            ...
            { vissitingAnotherProfileAndAuth && (<Flex gap={4} alignItems={'center'} justifyContent={'center'}>
