...
import { VStack,Avatar, Box,GridItem, Flex, Text, Image,useDisclosure, Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody, Divider } from '@chakra-ui/react'
...
const ProfilePost = ({img}) => {
  ...
  return (
    ...
    <Image src={img} alt='profile posts' w={'100%'} h={'100%'} objectFit={'cover'}/>
    </GridItem>
          ...
          <ModalBody bg={'black'} pb={5}>
            ...
            <Flex gap={4} w={{base: '90%', sm: '70%', md: 'full'}} maxH={"90vh"}
              ...
              <Flex borderRadius={4} overflow={'hidden'} border={'1px solid'} borderColor={'whiteAlpha.300'} flex={1.5}>
                ...
                <Image src={img} alt='profile post for modal look' />
              ...
              <Flex flex={1} flexDirection={'column'} px={10} display={{base:'none',md:'flex'}}>
                ...
                <Flex alignItems={'center'} gap={4}>
                  <Avatar src='/profilepic.png' size={'sm'} name='Artist_1'/>
