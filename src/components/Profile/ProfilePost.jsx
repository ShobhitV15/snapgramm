...
import { VStack,Avatar, Box,GridItem, Flex, Text, Image,useDisclosure, Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody, Divider, Button } from '@chakra-ui/react'
...
const ProfilePost = ({post}) => {
  ...
  return (
    ...
    <Flex opacity={0}
    _hover={{opacity:1}} position={'absolute'} top={0} left={0} right={0} 
    ...
    <Image src={post.imageURL} alt='profile posts' w={'100%'} h={'100%'} objectFit={'cover'}/>
    </GridItem>
    ...
    >
        ...
        <ModalContent>
          ...
          <ModalBody bg={'black'} pb={5}>
            ...
            <Flex gap={4} w={{base: '90%', sm: '70%', md: 'full'}} maxH={"90vh"}
							minH={"50vh"}>
              ...
              <Flex borderRadius={4} overflow={'hidden'} border={'1px solid'} borderColor={'whiteAlpha.300'} flex={1.5} justifyContent={'center'} alignItems={'center'}>
                ...
                <Image src={post.imageURL} alt='profile post for modal look' />
              ...
              <Flex flex={1} flexDirection={'column'} px={10} display={{base:'none',md:'flex'}}>
                ...
                <Flex alignItems={'center'} gap={4}>
                  <Avatar src={userProfile.profilePicURL} size={'sm'} name='Artist_1'/>
